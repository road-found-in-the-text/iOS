//
//  MyPageMyCommentViewController.swift
//  UMC_iOS_Ver_1
//
...
class MyPageMyCommentViewController: UIViewController {
...
extension MyPageMyCommentViewController: UITableViewDelegate, UITableViewDataSource {
